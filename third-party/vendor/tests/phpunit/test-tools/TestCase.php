...
use WP2FA_Vendor\PHPUnit\Framework\TestResult;
use WP2FA_Vendor\Text_Template;
use WP2FA_Vendor\WP_Mock;
use WP2FA_Vendor\WP_Mock\Tools\TestCase as BaseTestCase;
class TestCase extends \WP2FA_Vendor\WP_Mock\Tools\TestCase
{
    public function run(\WP2FA_Vendor\PHPUnit\Framework\TestResult $result = null) : \WP2FA_Vendor\PHPUnit\Framework\TestResult
    {
    ...
    public function assertActionsCalled()
    {
        ...
        try {
            \WP2FA_Vendor\WP_Mock::assertActionsCalled();
        } catch (\WP2FA_Vendor\WP2FA\Exception $e) {
            $actions_not_added = 1;
    ...
    public function ns($function)
    {
        ...
        $thisClassName = \trim(\get_class($this), '\\');
     ...
     */
    public function prepareTemplate(\WP2FA_Vendor\Text_Template $template)
    {
