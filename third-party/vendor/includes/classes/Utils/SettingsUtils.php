...
class SettingsUtils
{
    ...
    public static function get_option($setting_name, $default_value = \false)
    {
        ...
        return \WP2FA_Vendor\WP2FA\WP2FA::is_this_multisite() ? get_network_option(null, $prefixed_setting_name, $default_value) : get_option($prefixed_setting_name, $default_value);
    }
    public static function update_option($setting_name, $new_value)
    {
        $prefixed_setting_name = self::setting_prefixer($setting_name);
        return \WP2FA_Vendor\WP2FA\WP2FA::is_this_multisite() ? update_network_option(null, $prefixed_setting_name, $new_value) : update_option($prefixed_setting_name, $new_value, \true);
    }
    public static function delete_option($setting_name)
    {
        $prefixed_setting_name = self::setting_prefixer($setting_name);
        return \WP2FA_Vendor\WP2FA\WP2FA::is_this_multisite() ? delete_network_option(null, $prefixed_setting_name) : delete_option($prefixed_setting_name);
    }
    /**
