 ...
 */
if (!\class_exists('WP2FA_Vendor\\WP2FA\\Utils\\AbstractMigration')) {
    /**
    ...
    class AbstractMigration
    {
        ...
        public static function migrate()
        {
            if (\version_compare(static::getStoredVersion(), \constant(static::$constNameOfPluginVersion), '<')) {
                ...
                $migrateMethods = \array_filter($methodAsVersionNumbers, function ($method, $key) use(&$storedVersionAsNumber, &$targetVersionAsNumber) {
        ...
        {
            if ('' === \trim(static::$storedVersion)) {
                static::$storedVersion = \WP2FA_Vendor\WP2FA\Utils\SettingsUtils::get_option(static::$versionOptionName, '0.0.0');
            }
        ...
        {
            \WP2FA_Vendor\WP2FA\Utils\SettingsUtils::update_option(static::$versionOptionName, \constant(static::$constNameOfPluginVersion));
        }
        /**
