...
class FS_GDPR_Manager
{
    ...
    {
        $this->_storage = \WP2FA_Vendor\FS_Option_Manager::get_manager(\WP2FA_Vendor\WP_FS__GDPR_OPTION_NAME, \true, \true);
        $this->_wp_user_id = \WP2FA_Vendor\Freemius::get_current_wp_user_id();
        $this->_option_name = "u{$this->_wp_user_id}";
        $this->_data = $this->_storage->get_option($this->_option_name, array());
        $this->_notices = \WP2FA_Vendor\FS_Admin_Notices::instance('all_admins', '', '', \true);
    ...
    private function update_option($name, $value)
    {
        ...
        $this->_storage->set_option($this->_option_name, $this->_data, \true);
    }
    /**
    ...
    {
        return isset($this->_data['required']) ? $this->_data['required'] : null;
    }
    /**
     * @author Leo Fajardo (@leorw)
     * @since  2.1.0
    ...
    {
        return $this->_notices->has_sticky("gdpr_optin_actions_{$this->_wp_user_id}", \true);
    }
    /**
    ...
    {
        $this->_notices->remove_sticky("gdpr_optin_actions_{$this->_wp_user_id}", \true);
    ...
    {
        return !isset($this->_data['show_opt_in_notice']) || \true === $this->_data['show_opt_in_notice'];
    }
    /**
    ...
    {
        return isset($this->_data['notice_shown_at']) ? $this->_data['notice_shown_at'] : \false;
    }
    /**
    ...
    {
        $this->update_option('notice_shown_at', \WP2FA_Vendor\WP_FS__SCRIPT_START_TIME);
    }
    /**
    ...
    {
        $this->_notices->add_sticky($message, "gdpr_optin_actions_{$this->_wp_user_id}", '', 'promotion', \true, $this->_wp_user_id, $plugin_title, \true);
    }
}
