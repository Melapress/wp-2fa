 ...
 */
class FS_Plugin_Plan extends \WP2FA_Vendor\FS_Entity
{
    #region Properties
    /**
     * @var number
    ...
    {
        return !empty($this->support_email) || !empty($this->support_skype) || !empty($this->support_phone) || !empty($this->is_success_manager);
    }
    /**
     * @author Vova Feldman (@svovaf)
     * @since  1.0.9
    ...
    function has_trial()
    {
        return !$this->is_free() && \is_numeric($this->trial_period) && $this->trial_period > 0;
    }
}
