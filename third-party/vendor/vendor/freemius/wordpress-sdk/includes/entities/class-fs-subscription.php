...
class FS_Subscription extends \WP2FA_Vendor\FS_Entity
{
    #region Properties
    /**
     * @var number
    ...
    function is_active()
    {
        ...
        return !empty($this->next_payment) && \strtotime($this->next_payment) > \WP2FA_Vendor\WP_FS__SCRIPT_START_TIME;
    }
    /**
     * @author Vova Feldman (@svovaf)
     * @since  2.3.1
    ...
    {
        return \WP2FA_Vendor\WP_FS__TIME_24_HOURS_IN_SEC >= \strtotime($this->next_payment) - \strtotime($this->created);
    }
    /**
     * @author Vova Feldman (@svovaf)
     * @since  1.1.7
