...
$message = \sprintf(\WP2FA_Vendor\fs_text_inline('There is a new version of %s available.', 'new-version-available-message', $slug) . \WP2FA_Vendor\fs_text_inline(' %s to access version %s security & feature updates, and support.', 'x-for-updates-and-support', $slug), '<span id="plugin_name"></span>', \sprintf('<a id="pricing_url" href="">%s</a>', \is_object($license) ? \WP2FA_Vendor\fs_text_inline('Renew your license now', 'renew-license-now', $slug) : \WP2FA_Vendor\fs_text_inline('Buy a license now', 'buy-license-now', $slug)), '<span id="new_version"></span>');
$modal_content_html = "<p>{$message}</p>";
$header_title = \WP2FA_Vendor\fs_text_inline('New Version Available', 'new-version-available', $slug);
$renew_license_button_text = \is_object($license) ? \WP2FA_Vendor\fs_text_inline('Renew license', 'renew-license', $slug) : \WP2FA_Vendor\fs_text_inline('Buy license', 'buy-license', $slug);
...
echo \WP2FA_Vendor\esc_js(\WP2FA_Vendor\fs_text_x_inline('Dismiss', 'close a window', 'dismiss', $slug));
?>"></i></a>'
                + '     </div>'
                ...
                + '         <a class="button button-primary button-renew-license" tabindex="3" href="<?php 
echo $purchase_url;
?>"><?php 
echo \WP2FA_Vendor\esc_js($renew_license_button_text);
?></a>'
...
?></button>'
            ...
            $modal           = $( modalHtml ),
            isPluginsPage    = <?php 
echo \WP2FA_Vendor\Freemius::is_plugins_page() ? 'true' : 'false';
?>;
