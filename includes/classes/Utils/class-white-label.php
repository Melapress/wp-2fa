...
if ( ! class_exists( '\WP2FA\Utils\White_Label' ) ) {
	...
	class White_Label {
		...
		public static function get_setting( $setting_name = '', $get_default_on_empty = false ) {
			...
			$apply_defaults = empty( $white_label_setting );
