			...
			<div class="wp2fa-modal micromodal-slide" id="configure-2fa" aria-hidden="true">
				<div class="modal__overlay" tabindex="-1" data-micromodal-close>
					<div class="modal__container" role="dialog" aria-modal="true" aria-labelledby="modal-1-title">
						...
						<?php
						if ( 'yes' !== WP2FA::get_wp2fa_setting( 'hide-logo-wizard' ) ) {
						?>
							<p style="text-align: center; padding:0; margin: 0;"><img style="filter: invert(76.4%); width: 50px; margin: 0 auto;" src="<?php echo WP_2FA_URL . 'dist/images/wp-2fa-white-icon20x28.svg'?>" /></p>
						<?php } ?>
							<?php
