...
class SettingsPage {
	...
	private function remove2FALogo() {
		...
		<table class="form-table">
			<tbody>
				<tr>
					<th><label for="hide-logo-wizard"><?php esc_html_e( 'Remove plugin logo from 2FA wizard', 'wp-2fa' ); ?></label></th>
					<td>
						<fieldset>
							<input type="checkbox" id="hide-logo-wizard" name="wp_2fa_settings[hide-logo-wizard]" value="yes"
							<?php checked( WP2FA::get_wp2fa_setting( 'hide-logo-wizard' ), 'yes' ); ?>
							>
							<?php esc_html_e( 'Hide logo from the wizard', 'wp-2fa' ); ?>
						</fieldset>
					</td>
				</tr>
			</tbody>
