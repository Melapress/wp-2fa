...
use WP2FA_Vendor\Twilio\Rest\Accounts\V1;
/**
...
class Accounts extends Domain
{
    ...
    protected function getAuthTokenPromotion() : \WP2FA_Vendor\Twilio\Rest\Accounts\V1\AuthTokenPromotionList
    {
        return $this->v1->authTokenPromotion;
    }
    protected function contextAuthTokenPromotion() : \WP2FA_Vendor\Twilio\Rest\Accounts\V1\AuthTokenPromotionContext
    {
        return $this->v1->authTokenPromotion();
    }
    protected function getCredentials() : \WP2FA_Vendor\Twilio\Rest\Accounts\V1\CredentialList
    {
        return $this->v1->credentials;
    }
    protected function getSecondaryAuthToken() : \WP2FA_Vendor\Twilio\Rest\Accounts\V1\SecondaryAuthTokenList
    {
        return $this->v1->secondaryAuthToken;
    }
    protected function contextSecondaryAuthToken() : \WP2FA_Vendor\Twilio\Rest\Accounts\V1\SecondaryAuthTokenContext
    {
        return $this->v1->secondaryAuthToken();
    }
    /**
