...
use WP2FA_Vendor\Twilio\Rest\Sync\V1;
/**
...
class Sync extends Domain
{
    ...
    protected function getServices() : \WP2FA_Vendor\Twilio\Rest\Sync\V1\ServiceList
    {
     ...
     */
    protected function contextServices(string $sid) : \WP2FA_Vendor\Twilio\Rest\Sync\V1\ServiceContext
    {
