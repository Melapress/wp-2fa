 ...
 * /       /
 */
namespace WP2FA_Vendor\Twilio\Rest\Media\V1;
...
class MediaProcessorList extends ListResource
{
    ...
    public function create(string $extension, string $extensionContext, array $options = []) : MediaProcessorInstance
    {
        ...
        $data = Values::of(['Extension' => $extension, 'ExtensionContext' => $extensionContext, 'ExtensionEnvironment' => Serialize::jsonObject($options['extensionEnvironment']), 'StatusCallback' => $options['statusCallback'], 'StatusCallbackMethod' => $options['statusCallbackMethod'], 'MaxDuration' => $options['maxDuration']]);
    ...
    {
        $options = new Values($options);
        $params = Values::of(['Order' => $options['order'], 'Status' => $options['status'], 'PageToken' => $pageToken, 'Page' => $pageNumber, 'PageSize' => $pageSize]);
