...
class MediaRecordingList extends ListResource
{
    ...
    public function page(array $options = [], $pageSize = Values::NONE, string $pageToken = Values::NONE, $pageNumber = Values::NONE) : MediaRecordingPage
    {
        ...
        $params = Values::of(['Order' => $options['order'], 'Status' => $options['status'], 'ProcessorSid' => $options['processorSid'], 'SourceSid' => $options['sourceSid'], 'PageToken' => $pageToken, 'Page' => $pageNumber, 'PageSize' => $pageSize]);
