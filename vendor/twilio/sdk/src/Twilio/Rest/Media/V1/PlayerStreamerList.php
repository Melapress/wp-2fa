...
class PlayerStreamerList extends ListResource
{
    ...
    public function create(array $options = []) : PlayerStreamerInstance
    {
        ...
        $data = Values::of(['Video' => Serialize::booleanToString($options['video']), 'StatusCallback' => $options['statusCallback'], 'StatusCallbackMethod' => $options['statusCallbackMethod'], 'MaxDuration' => $options['maxDuration']]);
