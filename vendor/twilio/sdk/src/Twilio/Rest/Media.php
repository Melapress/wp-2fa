...
use WP2FA_Vendor\Twilio\Rest\Media\V1;
/**
...
class Media extends Domain
{
    ...
    protected function getMediaProcessor() : \WP2FA_Vendor\Twilio\Rest\Media\V1\MediaProcessorList
    {
     ...
     */
    protected function contextMediaProcessor(string $sid) : \WP2FA_Vendor\Twilio\Rest\Media\V1\MediaProcessorContext
    {
        return $this->v1->mediaProcessor($sid);
    }
    protected function getMediaRecording() : \WP2FA_Vendor\Twilio\Rest\Media\V1\MediaRecordingList
    {
     ...
     * @param string $sid The SID that identifies the resource to fetch
     */
    protected function contextMediaRecording(string $sid) : \WP2FA_Vendor\Twilio\Rest\Media\V1\MediaRecordingContext
    {
        return $this->v1->mediaRecording($sid);
    }
    protected function getPlayerStreamer() : \WP2FA_Vendor\Twilio\Rest\Media\V1\PlayerStreamerList
    {
     ...
     * @param string $sid The SID that identifies the resource to fetch
     */
    protected function contextPlayerStreamer(string $sid) : \WP2FA_Vendor\Twilio\Rest\Media\V1\PlayerStreamerContext
    {
