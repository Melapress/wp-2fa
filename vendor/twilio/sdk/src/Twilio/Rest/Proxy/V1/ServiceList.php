 ...
 * /       /
 */
namespace WP2FA_Vendor\Twilio\Rest\Proxy\V1;
...
class ServiceList extends ListResource
{
    ...
    public function create(string $uniqueName, array $options = []) : ServiceInstance
    {
        ...
        $data = Values::of(['UniqueName' => $uniqueName, 'DefaultTtl' => $options['defaultTtl'], 'CallbackUrl' => $options['callbackUrl'], 'GeoMatchLevel' => $options['geoMatchLevel'], 'NumberSelectionBehavior' => $options['numberSelectionBehavior'], 'InterceptCallbackUrl' => $options['interceptCallbackUrl'], 'OutOfSessionCallbackUrl' => $options['outOfSessionCallbackUrl'], 'ChatInstanceSid' => $options['chatInstanceSid']]);
