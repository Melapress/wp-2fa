...
use WP2FA_Vendor\Twilio\Rest\Video\V1;
/**
...
class Video extends Domain
{
    ...
    protected function getCompositions() : \WP2FA_Vendor\Twilio\Rest\Video\V1\CompositionList
    {
     ...
     */
    protected function contextCompositions(string $sid) : \WP2FA_Vendor\Twilio\Rest\Video\V1\CompositionContext
    {
        return $this->v1->compositions($sid);
    }
    protected function getCompositionHooks() : \WP2FA_Vendor\Twilio\Rest\Video\V1\CompositionHookList
    {
     ...
     * @param string $sid The SID that identifies the resource to fetch
     */
    protected function contextCompositionHooks(string $sid) : \WP2FA_Vendor\Twilio\Rest\Video\V1\CompositionHookContext
    {
        return $this->v1->compositionHooks($sid);
    }
    protected function getCompositionSettings() : \WP2FA_Vendor\Twilio\Rest\Video\V1\CompositionSettingsList
    {
        return $this->v1->compositionSettings;
    }
    protected function contextCompositionSettings() : \WP2FA_Vendor\Twilio\Rest\Video\V1\CompositionSettingsContext
    {
        return $this->v1->compositionSettings();
    }
    protected function getRecordings() : \WP2FA_Vendor\Twilio\Rest\Video\V1\RecordingList
    {
     ...
     * @param string $sid The SID that identifies the resource to fetch
     */
    protected function contextRecordings(string $sid) : \WP2FA_Vendor\Twilio\Rest\Video\V1\RecordingContext
    {
        return $this->v1->recordings($sid);
    }
    protected function getRecordingSettings() : \WP2FA_Vendor\Twilio\Rest\Video\V1\RecordingSettingsList
    {
        return $this->v1->recordingSettings;
    }
    protected function contextRecordingSettings() : \WP2FA_Vendor\Twilio\Rest\Video\V1\RecordingSettingsContext
    {
        return $this->v1->recordingSettings();
    }
    protected function getRooms() : \WP2FA_Vendor\Twilio\Rest\Video\V1\RoomList
    {
     ...
     * @param string $sid The SID that identifies the resource to fetch
     */
    protected function contextRooms(string $sid) : \WP2FA_Vendor\Twilio\Rest\Video\V1\RoomContext
    {
