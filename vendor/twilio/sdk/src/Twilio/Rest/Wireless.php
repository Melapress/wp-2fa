...
use WP2FA_Vendor\Twilio\Rest\Wireless\V1;
/**
...
class Wireless extends Domain
{
    ...
    protected function getUsageRecords() : \WP2FA_Vendor\Twilio\Rest\Wireless\V1\UsageRecordList
    {
        return $this->v1->usageRecords;
    }
    protected function getCommands() : \WP2FA_Vendor\Twilio\Rest\Wireless\V1\CommandList
    {
     ...
     */
    protected function contextCommands(string $sid) : \WP2FA_Vendor\Twilio\Rest\Wireless\V1\CommandContext
    {
        return $this->v1->commands($sid);
    }
    protected function getRatePlans() : \WP2FA_Vendor\Twilio\Rest\Wireless\V1\RatePlanList
    {
     ...
     * @param string $sid The SID that identifies the resource to fetch
     */
    protected function contextRatePlans(string $sid) : \WP2FA_Vendor\Twilio\Rest\Wireless\V1\RatePlanContext
    {
        return $this->v1->ratePlans($sid);
    }
    protected function getSims() : \WP2FA_Vendor\Twilio\Rest\Wireless\V1\SimList
    {
        return $this->v1->sims;
    }
    /**
     ...
     */
    protected function contextSims(string $sid) : \WP2FA_Vendor\Twilio\Rest\Wireless\V1\SimContext
    {
