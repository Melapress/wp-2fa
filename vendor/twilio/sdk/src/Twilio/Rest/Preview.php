...
use WP2FA_Vendor\Twilio\Rest\Preview\DeployedDevices as PreviewDeployedDevices;
use WP2FA_Vendor\Twilio\Rest\Preview\HostedNumbers as PreviewHostedNumbers;
use WP2FA_Vendor\Twilio\Rest\Preview\Marketplace as PreviewMarketplace;
use WP2FA_Vendor\Twilio\Rest\Preview\Sync as PreviewSync;
use WP2FA_Vendor\Twilio\Rest\Preview\Understand as PreviewUnderstand;
use WP2FA_Vendor\Twilio\Rest\Preview\Wireless as PreviewWireless;
/**
...
class Preview extends Domain
{
    ...
    protected function getFleets() : \WP2FA_Vendor\Twilio\Rest\Preview\DeployedDevices\FleetList
    {
     ...
     */
    protected function contextFleets(string $sid) : \WP2FA_Vendor\Twilio\Rest\Preview\DeployedDevices\FleetContext
    {
        return $this->deployedDevices->fleets($sid);
    }
    protected function getAuthorizationDocuments() : \WP2FA_Vendor\Twilio\Rest\Preview\HostedNumbers\AuthorizationDocumentList
    {
     ...
     */
    protected function contextAuthorizationDocuments(string $sid) : \WP2FA_Vendor\Twilio\Rest\Preview\HostedNumbers\AuthorizationDocumentContext
    {
        return $this->hostedNumbers->authorizationDocuments($sid);
    }
    protected function getHostedNumberOrders() : \WP2FA_Vendor\Twilio\Rest\Preview\HostedNumbers\HostedNumberOrderList
    {
     ...
     */
    protected function contextHostedNumberOrders(string $sid) : \WP2FA_Vendor\Twilio\Rest\Preview\HostedNumbers\HostedNumberOrderContext
    {
        return $this->hostedNumbers->hostedNumberOrders($sid);
    }
    protected function getAvailableAddOns() : \WP2FA_Vendor\Twilio\Rest\Preview\Marketplace\AvailableAddOnList
    {
     ...
     */
    protected function contextAvailableAddOns(string $sid) : \WP2FA_Vendor\Twilio\Rest\Preview\Marketplace\AvailableAddOnContext
    {
        return $this->marketplace->availableAddOns($sid);
    }
    protected function getInstalledAddOns() : \WP2FA_Vendor\Twilio\Rest\Preview\Marketplace\InstalledAddOnList
    {
     ...
     */
    protected function contextInstalledAddOns(string $sid) : \WP2FA_Vendor\Twilio\Rest\Preview\Marketplace\InstalledAddOnContext
    {
        return $this->marketplace->installedAddOns($sid);
    }
    protected function getServices() : \WP2FA_Vendor\Twilio\Rest\Preview\Sync\ServiceList
    {
     ...
     */
    protected function contextServices(string $sid) : \WP2FA_Vendor\Twilio\Rest\Preview\Sync\ServiceContext
    {
        return $this->sync->services($sid);
    }
    protected function getAssistants() : \WP2FA_Vendor\Twilio\Rest\Preview\Understand\AssistantList
    {
     ...
     *                    resource.
     */
    protected function contextAssistants(string $sid) : \WP2FA_Vendor\Twilio\Rest\Preview\Understand\AssistantContext
    {
        return $this->understand->assistants($sid);
    }
    protected function getCommands() : \WP2FA_Vendor\Twilio\Rest\Preview\Wireless\CommandList
    {
     ...
     * @param string $sid The sid
     */
    protected function contextCommands(string $sid) : \WP2FA_Vendor\Twilio\Rest\Preview\Wireless\CommandContext
    {
        return $this->wireless->commands($sid);
    }
    protected function getRatePlans() : \WP2FA_Vendor\Twilio\Rest\Preview\Wireless\RatePlanList
    {
     ...
     * @param string $sid The sid
     */
    protected function contextRatePlans(string $sid) : \WP2FA_Vendor\Twilio\Rest\Preview\Wireless\RatePlanContext
    {
        return $this->wireless->ratePlans($sid);
    }
    protected function getSims() : \WP2FA_Vendor\Twilio\Rest\Preview\Wireless\SimList
    {
     ...
     * @param string $sid The sid
     */
    protected function contextSims(string $sid) : \WP2FA_Vendor\Twilio\Rest\Preview\Wireless\SimContext
    {
