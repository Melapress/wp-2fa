...
use WP2FA_Vendor\Twilio\Rest\Notify\V1;
/**
...
class Notify extends Domain
{
    ...
    protected function getCredentials() : \WP2FA_Vendor\Twilio\Rest\Notify\V1\CredentialList
    {
     ...
     */
    protected function contextCredentials(string $sid) : \WP2FA_Vendor\Twilio\Rest\Notify\V1\CredentialContext
    {
        return $this->v1->credentials($sid);
    }
    protected function getServices() : \WP2FA_Vendor\Twilio\Rest\Notify\V1\ServiceList
    {
     ...
     * @param string $sid The unique string that identifies the resource
     */
    protected function contextServices(string $sid) : \WP2FA_Vendor\Twilio\Rest\Notify\V1\ServiceContext
    {
