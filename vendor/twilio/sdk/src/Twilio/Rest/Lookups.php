...
use WP2FA_Vendor\Twilio\Rest\Lookups\V1;
use WP2FA_Vendor\Twilio\Rest\Lookups\V2;
/**
...
class Lookups extends Domain
{
    ...
    protected function getPhoneNumbers() : \WP2FA_Vendor\Twilio\Rest\Lookups\V1\PhoneNumberList
    {
     ...
     */
    protected function contextPhoneNumbers(string $phoneNumber) : \WP2FA_Vendor\Twilio\Rest\Lookups\V1\PhoneNumberContext
    {
