...
use WP2FA_Vendor\Twilio\Rest\Conversations\V1;
/**
...
class Conversations extends Domain
{
    ...
    protected function getConfiguration() : \WP2FA_Vendor\Twilio\Rest\Conversations\V1\ConfigurationList
    {
        return $this->v1->configuration;
    }
    protected function contextConfiguration() : \WP2FA_Vendor\Twilio\Rest\Conversations\V1\ConfigurationContext
    {
        return $this->v1->configuration();
    }
    protected function getAddressConfigurations() : \WP2FA_Vendor\Twilio\Rest\Conversations\V1\AddressConfigurationList
    {
     ...
     */
    protected function contextAddressConfigurations(string $sid) : \WP2FA_Vendor\Twilio\Rest\Conversations\V1\AddressConfigurationContext
    {
        return $this->v1->addressConfigurations($sid);
    }
    protected function getConversations() : \WP2FA_Vendor\Twilio\Rest\Conversations\V1\ConversationList
    {
     ...
     *                    resource.
     */
    protected function contextConversations(string $sid) : \WP2FA_Vendor\Twilio\Rest\Conversations\V1\ConversationContext
    {
        return $this->v1->conversations($sid);
    }
    protected function getCredentials() : \WP2FA_Vendor\Twilio\Rest\Conversations\V1\CredentialList
    {
     ...
     *                    resource.
     */
    protected function contextCredentials(string $sid) : \WP2FA_Vendor\Twilio\Rest\Conversations\V1\CredentialContext
    {
        return $this->v1->credentials($sid);
    }
    protected function getParticipantConversations() : \WP2FA_Vendor\Twilio\Rest\Conversations\V1\ParticipantConversationList
    {
        return $this->v1->participantConversations;
    }
    protected function getRoles() : \WP2FA_Vendor\Twilio\Rest\Conversations\V1\RoleList
    {
     ...
     */
    protected function contextRoles(string $sid) : \WP2FA_Vendor\Twilio\Rest\Conversations\V1\RoleContext
    {
        return $this->v1->roles($sid);
    }
    protected function getServices() : \WP2FA_Vendor\Twilio\Rest\Conversations\V1\ServiceList
    {
     ...
     *                    resource.
     */
    protected function contextServices(string $sid) : \WP2FA_Vendor\Twilio\Rest\Conversations\V1\ServiceContext
    {
        return $this->v1->services($sid);
    }
    protected function getUsers() : \WP2FA_Vendor\Twilio\Rest\Conversations\V1\UserList
    {
     ...
     */
    protected function contextUsers(string $sid) : \WP2FA_Vendor\Twilio\Rest\Conversations\V1\UserContext
    {
