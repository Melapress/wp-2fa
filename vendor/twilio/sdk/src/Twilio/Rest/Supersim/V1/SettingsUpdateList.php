...
class SettingsUpdateList extends ListResource
{
    ...
    public function page(array $options = [], $pageSize = Values::NONE, string $pageToken = Values::NONE, $pageNumber = Values::NONE) : SettingsUpdatePage
    {
        ...
        $params = Values::of(['Sim' => $options['sim'], 'Status' => $options['status'], 'PageToken' => $pageToken, 'Page' => $pageNumber, 'PageSize' => $pageSize]);
        $response = $this->version->page('GET', $this->uri, $params);
        return new SettingsUpdatePage($this->version, $response, $this->solution);
    }
    /**
