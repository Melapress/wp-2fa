...
use WP2FA_Vendor\Twilio\Rest\Verify\V2;
/**
...
class Verify extends Domain
{
    ...
    protected function getForms() : \WP2FA_Vendor\Twilio\Rest\Verify\V2\FormList
    {
     ...
     */
    protected function contextForms(string $formType) : \WP2FA_Vendor\Twilio\Rest\Verify\V2\FormContext
    {
        return $this->v2->forms($formType);
    }
    protected function getSafelist() : \WP2FA_Vendor\Twilio\Rest\Verify\V2\SafelistList
    {
     ...
     */
    protected function contextSafelist(string $phoneNumber) : \WP2FA_Vendor\Twilio\Rest\Verify\V2\SafelistContext
    {
        return $this->v2->safelist($phoneNumber);
    }
    protected function getServices() : \WP2FA_Vendor\Twilio\Rest\Verify\V2\ServiceList
    {
     ...
     */
    protected function contextServices(string $sid) : \WP2FA_Vendor\Twilio\Rest\Verify\V2\ServiceContext
    {
        return $this->v2->services($sid);
    }
    protected function getVerificationAttempts() : \WP2FA_Vendor\Twilio\Rest\Verify\V2\VerificationAttemptList
    {
     ...
     */
    protected function contextVerificationAttempts(string $sid) : \WP2FA_Vendor\Twilio\Rest\Verify\V2\VerificationAttemptContext
    {
        return $this->v2->verificationAttempts($sid);
    }
    protected function getVerificationAttemptsSummary() : \WP2FA_Vendor\Twilio\Rest\Verify\V2\VerificationAttemptsSummaryList
    {
        return $this->v2->verificationAttemptsSummary;
    }
    protected function contextVerificationAttemptsSummary() : \WP2FA_Vendor\Twilio\Rest\Verify\V2\VerificationAttemptsSummaryContext
    {
        return $this->v2->verificationAttemptsSummary();
    }
    protected function getTemplates() : \WP2FA_Vendor\Twilio\Rest\Verify\V2\TemplateList
    {
