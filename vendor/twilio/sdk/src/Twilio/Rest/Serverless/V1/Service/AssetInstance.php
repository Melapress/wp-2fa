...
use WP2FA_Vendor\Twilio\Rest\Serverless\V1\Service\Asset\AssetVersionList;
...
class AssetInstance extends InstanceResource
{
    ...
    {
        if (!$this->context) {
            $this->context = new AssetContext($this->version, $this->solution['serviceSid'], $this->solution['sid']);
        }
        return $this->context;
    }
    /**
