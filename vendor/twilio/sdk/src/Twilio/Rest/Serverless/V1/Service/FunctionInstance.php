...
use WP2FA_Vendor\Twilio\Rest\Serverless\V1\Service\TwilioFunction\FunctionVersionList;
...
class FunctionInstance extends InstanceResource
{
    ...
    {
        if (!$this->context) {
            $this->context = new FunctionContext($this->version, $this->solution['serviceSid'], $this->solution['sid']);
        }
        return $this->context;
    }
    /**
