...
use WP2FA_Vendor\Twilio\Rest\Microvisor\V1;
/**
...
class Microvisor extends Domain
{
    ...
    protected function getApps() : \WP2FA_Vendor\Twilio\Rest\Microvisor\V1\AppList
    {
        return $this->v1->apps;
    }
    /**
     ...
     */
    protected function contextApps(string $sid) : \WP2FA_Vendor\Twilio\Rest\Microvisor\V1\AppContext
    {
        return $this->v1->apps($sid);
    }
    protected function getDevices() : \WP2FA_Vendor\Twilio\Rest\Microvisor\V1\DeviceList
    {
     ...
     */
    protected function contextDevices(string $sid) : \WP2FA_Vendor\Twilio\Rest\Microvisor\V1\DeviceContext
    {
