...
use WP2FA_Vendor\Twilio\Rest\Conversations\V1\Conversation\Message\DeliveryReceiptList;
...
class MessageInstance extends InstanceResource
{
    ...
    {
        if (!$this->context) {
            $this->context = new MessageContext($this->version, $this->solution['conversationSid'], $this->solution['sid']);
        }
        return $this->context;
    }
    /**
