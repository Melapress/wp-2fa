...
class MessageContext extends InstanceContext
{
    ...
    public function update(array $options = []) : MessageInstance
    {
        ...
        return new MessageInstance($this->version, $payload, $this->solution['chatServiceSid'], $this->solution['conversationSid'], $this->solution['sid']);
    }
    /**
    ...
    protected function getDeliveryReceipts() : DeliveryReceiptList
    {
        if (!$this->_deliveryReceipts) {
            $this->_deliveryReceipts = new DeliveryReceiptList($this->version, $this->solution['chatServiceSid'], $this->solution['conversationSid'], $this->solution['sid']);
        }
