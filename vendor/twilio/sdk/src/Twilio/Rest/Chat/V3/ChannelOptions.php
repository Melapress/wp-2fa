...
abstract class ChannelOptions
{
     ...
     */
    public static function update(string $type = Values::NONE, string $messagingServiceSid = Values::NONE, string $xTwilioWebhookEnabled = Values::NONE) : UpdateChannelOptions
    {
...
class UpdateChannelOptions extends Options
{
     ...
     *                                      request header
     */
    public function __construct(string $type = Values::NONE, string $messagingServiceSid = Values::NONE, string $xTwilioWebhookEnabled = Values::NONE)
    {
