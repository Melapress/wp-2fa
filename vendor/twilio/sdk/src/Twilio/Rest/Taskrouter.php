...
use WP2FA_Vendor\Twilio\Rest\Taskrouter\V1;
/**
...
class Taskrouter extends Domain
{
    ...
    protected function getWorkspaces() : \WP2FA_Vendor\Twilio\Rest\Taskrouter\V1\WorkspaceList
    {
     ...
     */
    protected function contextWorkspaces(string $sid) : \WP2FA_Vendor\Twilio\Rest\Taskrouter\V1\WorkspaceContext
    {
