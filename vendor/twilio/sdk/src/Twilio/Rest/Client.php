...
use WP2FA_Vendor\Twilio\Http\Client as HttpClient;
use WP2FA_Vendor\Twilio\Http\CurlClient;
use WP2FA_Vendor\Twilio\Security\RequestValidator;
use WP2FA_Vendor\Twilio\VersionInfo;
/**
...
class Client
{
     ...
     */
    public function request(string $method, string $uri, array $params = [], array $data = [], array $headers = [], string $username = null, string $password = null, int $timeout = null) : \WP2FA_Vendor\Twilio\Http\Response
    {
        $username = $username ?: $this->username;
        $password = $password ?: $this->password;
        $logLevel = \getenv('DEBUG_HTTP_TRAFFIC') === 'true' ? 'debug' : $this->getLogLevel();
        $headers['User-Agent'] = 'twilio-php/' . VersionInfo::string() . ' (' . \php_uname("s") . ' ' . \php_uname("m") . ')' . ' PHP/' . \PHP_VERSION;
     ...
     */
    public function getAccount() : \WP2FA_Vendor\Twilio\Rest\Api\V2010\AccountContext
    {
        return $this->api->v2010->account;
    }
    protected function getAddresses() : \WP2FA_Vendor\Twilio\Rest\Api\V2010\Account\AddressList
    {
     ...
     */
    protected function contextAddresses(string $sid) : \WP2FA_Vendor\Twilio\Rest\Api\V2010\Account\AddressContext
    {
        return $this->api->v2010->account->addresses($sid);
    }
    protected function getApplications() : \WP2FA_Vendor\Twilio\Rest\Api\V2010\Account\ApplicationList
    {
     ...
     * @param string $sid The unique string that identifies the resource
     */
    protected function contextApplications(string $sid) : \WP2FA_Vendor\Twilio\Rest\Api\V2010\Account\ApplicationContext
    {
        return $this->api->v2010->account->applications($sid);
    }
    protected function getAuthorizedConnectApps() : \WP2FA_Vendor\Twilio\Rest\Api\V2010\Account\AuthorizedConnectAppList
    {
     ...
     */
    protected function contextAuthorizedConnectApps(string $connectAppSid) : \WP2FA_Vendor\Twilio\Rest\Api\V2010\Account\AuthorizedConnectAppContext
    {
        return $this->api->v2010->account->authorizedConnectApps($connectAppSid);
    }
    protected function getAvailablePhoneNumbers() : \WP2FA_Vendor\Twilio\Rest\Api\V2010\Account\AvailablePhoneNumberCountryList
    {
     ...
     */
    protected function contextAvailablePhoneNumbers(string $countryCode) : \WP2FA_Vendor\Twilio\Rest\Api\V2010\Account\AvailablePhoneNumberCountryContext
    {
        return $this->api->v2010->account->availablePhoneNumbers($countryCode);
    }
    protected function getBalance() : \WP2FA_Vendor\Twilio\Rest\Api\V2010\Account\BalanceList
    {
        return $this->api->v2010->account->balance;
    }
    protected function getCalls() : \WP2FA_Vendor\Twilio\Rest\Api\V2010\Account\CallList
    {
     ...
     */
    protected function contextCalls(string $sid) : \WP2FA_Vendor\Twilio\Rest\Api\V2010\Account\CallContext
    {
        return $this->api->v2010->account->calls($sid);
    }
    protected function getConferences() : \WP2FA_Vendor\Twilio\Rest\Api\V2010\Account\ConferenceList
    {
     ...
     */
    protected function contextConferences(string $sid) : \WP2FA_Vendor\Twilio\Rest\Api\V2010\Account\ConferenceContext
    {
        return $this->api->v2010->account->conferences($sid);
    }
    protected function getConnectApps() : \WP2FA_Vendor\Twilio\Rest\Api\V2010\Account\ConnectAppList
    {
     ...
     * @param string $sid The unique string that identifies the resource
     */
    protected function contextConnectApps(string $sid) : \WP2FA_Vendor\Twilio\Rest\Api\V2010\Account\ConnectAppContext
    {
        return $this->api->v2010->account->connectApps($sid);
    }
    protected function getIncomingPhoneNumbers() : \WP2FA_Vendor\Twilio\Rest\Api\V2010\Account\IncomingPhoneNumberList
    {
     ...
     * @param string $sid The unique string that identifies the resource
     */
    protected function contextIncomingPhoneNumbers(string $sid) : \WP2FA_Vendor\Twilio\Rest\Api\V2010\Account\IncomingPhoneNumberContext
    {
        return $this->api->v2010->account->incomingPhoneNumbers($sid);
    }
    protected function getKeys() : \WP2FA_Vendor\Twilio\Rest\Api\V2010\Account\KeyList
    {
     ...
     * @param string $sid The unique string that identifies the resource
     */
    protected function contextKeys(string $sid) : \WP2FA_Vendor\Twilio\Rest\Api\V2010\Account\KeyContext
    {
        return $this->api->v2010->account->keys($sid);
    }
    protected function getMessages() : \WP2FA_Vendor\Twilio\Rest\Api\V2010\Account\MessageList
    {
     ...
     * @param string $sid The unique string that identifies the resource
     */
    protected function contextMessages(string $sid) : \WP2FA_Vendor\Twilio\Rest\Api\V2010\Account\MessageContext
    {
        return $this->api->v2010->account->messages($sid);
    }
    protected function getNewKeys() : \WP2FA_Vendor\Twilio\Rest\Api\V2010\Account\NewKeyList
    {
        return $this->api->v2010->account->newKeys;
    }
    protected function getNewSigningKeys() : \WP2FA_Vendor\Twilio\Rest\Api\V2010\Account\NewSigningKeyList
    {
        return $this->api->v2010->account->newSigningKeys;
    }
    protected function getNotifications() : \WP2FA_Vendor\Twilio\Rest\Api\V2010\Account\NotificationList
    {
     ...
     * @param string $sid The unique string that identifies the resource
     */
    protected function contextNotifications(string $sid) : \WP2FA_Vendor\Twilio\Rest\Api\V2010\Account\NotificationContext
    {
        return $this->api->v2010->account->notifications($sid);
    }
    protected function getOutgoingCallerIds() : \WP2FA_Vendor\Twilio\Rest\Api\V2010\Account\OutgoingCallerIdList
    {
     ...
     * @param string $sid The unique string that identifies the resource
     */
    protected function contextOutgoingCallerIds(string $sid) : \WP2FA_Vendor\Twilio\Rest\Api\V2010\Account\OutgoingCallerIdContext
    {
        return $this->api->v2010->account->outgoingCallerIds($sid);
    }
    protected function getQueues() : \WP2FA_Vendor\Twilio\Rest\Api\V2010\Account\QueueList
    {
     ...
     * @param string $sid The unique string that identifies this resource
     */
    protected function contextQueues(string $sid) : \WP2FA_Vendor\Twilio\Rest\Api\V2010\Account\QueueContext
    {
        return $this->api->v2010->account->queues($sid);
    }
    protected function getRecordings() : \WP2FA_Vendor\Twilio\Rest\Api\V2010\Account\RecordingList
    {
     ...
     * @param string $sid The unique string that identifies the resource
     */
    protected function contextRecordings(string $sid) : \WP2FA_Vendor\Twilio\Rest\Api\V2010\Account\RecordingContext
    {
        return $this->api->v2010->account->recordings($sid);
    }
    protected function getSigningKeys() : \WP2FA_Vendor\Twilio\Rest\Api\V2010\Account\SigningKeyList
    {
     ...
     */
    protected function contextSigningKeys(string $sid) : \WP2FA_Vendor\Twilio\Rest\Api\V2010\Account\SigningKeyContext
    {
        return $this->api->v2010->account->signingKeys($sid);
    }
    protected function getSip() : \WP2FA_Vendor\Twilio\Rest\Api\V2010\Account\SipList
    {
        return $this->api->v2010->account->sip;
    }
    protected function getShortCodes() : \WP2FA_Vendor\Twilio\Rest\Api\V2010\Account\ShortCodeList
    {
     ...
     * @param string $sid The unique string that identifies this resource
     */
    protected function contextShortCodes(string $sid) : \WP2FA_Vendor\Twilio\Rest\Api\V2010\Account\ShortCodeContext
    {
        return $this->api->v2010->account->shortCodes($sid);
    }
    protected function getTokens() : \WP2FA_Vendor\Twilio\Rest\Api\V2010\Account\TokenList
    {
        return $this->api->v2010->account->tokens;
    }
    protected function getTranscriptions() : \WP2FA_Vendor\Twilio\Rest\Api\V2010\Account\TranscriptionList
    {
     ...
     * @param string $sid The unique string that identifies the resource
     */
    protected function contextTranscriptions(string $sid) : \WP2FA_Vendor\Twilio\Rest\Api\V2010\Account\TranscriptionContext
    {
        return $this->api->v2010->account->transcriptions($sid);
    }
    protected function getUsage() : \WP2FA_Vendor\Twilio\Rest\Api\V2010\Account\UsageList
    {
        return $this->api->v2010->account->usage;
    }
    protected function getValidationRequests() : \WP2FA_Vendor\Twilio\Rest\Api\V2010\Account\ValidationRequestList
    {
