...
use WP2FA_Vendor\Twilio\Rest\Events\V1;
/**
...
class Events extends Domain
{
    ...
    protected function getEventTypes() : \WP2FA_Vendor\Twilio\Rest\Events\V1\EventTypeList
    {
     ...
     */
    protected function contextEventTypes(string $type) : \WP2FA_Vendor\Twilio\Rest\Events\V1\EventTypeContext
    {
        return $this->v1->eventTypes($type);
    }
    protected function getSchemas() : \WP2FA_Vendor\Twilio\Rest\Events\V1\SchemaList
    {
     ...
     */
    protected function contextSchemas(string $id) : \WP2FA_Vendor\Twilio\Rest\Events\V1\SchemaContext
    {
        return $this->v1->schemas($id);
    }
    protected function getSinks() : \WP2FA_Vendor\Twilio\Rest\Events\V1\SinkList
    {
     ...
     */
    protected function contextSinks(string $sid) : \WP2FA_Vendor\Twilio\Rest\Events\V1\SinkContext
    {
        return $this->v1->sinks($sid);
    }
    protected function getSubscriptions() : \WP2FA_Vendor\Twilio\Rest\Events\V1\SubscriptionList
    {
     ...
     */
    protected function contextSubscriptions(string $sid) : \WP2FA_Vendor\Twilio\Rest\Events\V1\SubscriptionContext
    {
