...
use WP2FA_Vendor\Twilio\Rest\Content\V1;
/**
...
class Content extends Domain
{
    ...
    protected function getContents() : \WP2FA_Vendor\Twilio\Rest\Content\V1\ContentList
    {
     ...
     */
    protected function contextContents(string $sid) : \WP2FA_Vendor\Twilio\Rest\Content\V1\ContentContext
    {
