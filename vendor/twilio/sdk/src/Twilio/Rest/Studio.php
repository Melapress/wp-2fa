...
use WP2FA_Vendor\Twilio\Rest\Studio\V1;
use WP2FA_Vendor\Twilio\Rest\Studio\V2;
/**
...
class Studio extends Domain
{
    ...
    protected function getFlows() : \WP2FA_Vendor\Twilio\Rest\Studio\V2\FlowList
    {
     ...
     */
    protected function contextFlows(string $sid) : \WP2FA_Vendor\Twilio\Rest\Studio\V2\FlowContext
    {
        return $this->v2->flows($sid);
    }
    protected function getFlowValidate() : \WP2FA_Vendor\Twilio\Rest\Studio\V2\FlowValidateList
    {
