...
use WP2FA_Vendor\Twilio\Rest\Supersim\V1;
/**
...
class Supersim extends Domain
{
    ...
    protected function getEsimProfiles() : \WP2FA_Vendor\Twilio\Rest\Supersim\V1\EsimProfileList
    {
     ...
     */
    protected function contextEsimProfiles(string $sid) : \WP2FA_Vendor\Twilio\Rest\Supersim\V1\EsimProfileContext
    {
        return $this->v1->esimProfiles($sid);
    }
    protected function getFleets() : \WP2FA_Vendor\Twilio\Rest\Supersim\V1\FleetList
    {
     ...
     */
    protected function contextFleets(string $sid) : \WP2FA_Vendor\Twilio\Rest\Supersim\V1\FleetContext
    {
        return $this->v1->fleets($sid);
    }
    protected function getIpCommands() : \WP2FA_Vendor\Twilio\Rest\Supersim\V1\IpCommandList
    {
     ...
     * @param string $sid The SID that identifies the resource to fetch
     */
    protected function contextIpCommands(string $sid) : \WP2FA_Vendor\Twilio\Rest\Supersim\V1\IpCommandContext
    {
        return $this->v1->ipCommands($sid);
    }
    protected function getNetworks() : \WP2FA_Vendor\Twilio\Rest\Supersim\V1\NetworkList
    {
     ...
     */
    protected function contextNetworks(string $sid) : \WP2FA_Vendor\Twilio\Rest\Supersim\V1\NetworkContext
    {
        return $this->v1->networks($sid);
    }
    protected function getNetworkAccessProfiles() : \WP2FA_Vendor\Twilio\Rest\Supersim\V1\NetworkAccessProfileList
    {
     ...
     * @param string $sid The SID that identifies the resource to fetch
     */
    protected function contextNetworkAccessProfiles(string $sid) : \WP2FA_Vendor\Twilio\Rest\Supersim\V1\NetworkAccessProfileContext
    {
        return $this->v1->networkAccessProfiles($sid);
    }
    protected function getSettingsUpdates() : \WP2FA_Vendor\Twilio\Rest\Supersim\V1\SettingsUpdateList
    {
        return $this->v1->settingsUpdates;
    }
    protected function getSims() : \WP2FA_Vendor\Twilio\Rest\Supersim\V1\SimList
    {
        return $this->v1->sims;
    }
    /**
     * @param string $sid The SID that identifies the resource to fetch
     */
    protected function contextSims(string $sid) : \WP2FA_Vendor\Twilio\Rest\Supersim\V1\SimContext
    {
        return $this->v1->sims($sid);
    }
    protected function getSmsCommands() : \WP2FA_Vendor\Twilio\Rest\Supersim\V1\SmsCommandList
    {
     ...
     * @param string $sid The SID that identifies the resource to fetch
     */
    protected function contextSmsCommands(string $sid) : \WP2FA_Vendor\Twilio\Rest\Supersim\V1\SmsCommandContext
    {
        return $this->v1->smsCommands($sid);
    }
    protected function getUsageRecords() : \WP2FA_Vendor\Twilio\Rest\Supersim\V1\UsageRecordList
    {
