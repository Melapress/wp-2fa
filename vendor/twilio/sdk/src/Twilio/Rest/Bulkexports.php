...
use WP2FA_Vendor\Twilio\Rest\Bulkexports\V1;
/**
...
class Bulkexports extends Domain
{
    ...
    protected function getExports() : \WP2FA_Vendor\Twilio\Rest\Bulkexports\V1\ExportList
    {
     ...
     */
    protected function contextExports(string $resourceType) : \WP2FA_Vendor\Twilio\Rest\Bulkexports\V1\ExportContext
    {
        return $this->v1->exports($resourceType);
    }
    protected function getExportConfiguration() : \WP2FA_Vendor\Twilio\Rest\Bulkexports\V1\ExportConfigurationList
    {
     ...
     *                             Conferences, and Participants
     */
    protected function contextExportConfiguration(string $resourceType) : \WP2FA_Vendor\Twilio\Rest\Bulkexports\V1\ExportConfigurationContext
    {
