...
use WP2FA_Vendor\Twilio\Rest\IpMessaging\V1;
use WP2FA_Vendor\Twilio\Rest\IpMessaging\V2;
/**
...
class IpMessaging extends Domain
{
    ...
    protected function getCredentials() : \WP2FA_Vendor\Twilio\Rest\IpMessaging\V2\CredentialList
    {
     ...
     */
    protected function contextCredentials(string $sid) : \WP2FA_Vendor\Twilio\Rest\IpMessaging\V2\CredentialContext
    {
        return $this->v2->credentials($sid);
    }
    protected function getServices() : \WP2FA_Vendor\Twilio\Rest\IpMessaging\V2\ServiceList
    {
     ...
     * @param string $sid The sid
     */
    protected function contextServices(string $sid) : \WP2FA_Vendor\Twilio\Rest\IpMessaging\V2\ServiceContext
    {
