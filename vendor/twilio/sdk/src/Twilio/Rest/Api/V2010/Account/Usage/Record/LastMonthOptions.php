...
abstract class LastMonthOptions
{
     ...
     */
    public static function read(string $category = Values::NONE, \DateTime $startDate = Values::NONE, \DateTime $endDate = Values::NONE, bool $includeSubaccounts = Values::NONE) : ReadLastMonthOptions
    {
