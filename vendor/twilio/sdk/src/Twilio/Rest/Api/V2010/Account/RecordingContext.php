...
use WP2FA_Vendor\Twilio\Rest\Api\V2010\Account\Recording\AddOnResultList;
use WP2FA_Vendor\Twilio\Rest\Api\V2010\Account\Recording\TranscriptionList;
...
class RecordingContext extends InstanceContext
{
    ...
    public function fetch(array $options = []) : RecordingInstance
    {
        ...
        $params = Values::of(['IncludeSoftDeleted' => Serialize::booleanToString($options['includeSoftDeleted'])]);
