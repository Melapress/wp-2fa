 ...
 * /       /
 */
namespace WP2FA_Vendor\Twilio\Rest\Api\V2010\Account\Sip\CredentialList;
...
class CredentialInstance extends InstanceResource
{
    ...
    {
        if (!$this->context) {
            $this->context = new CredentialContext($this->version, $this->solution['accountSid'], $this->solution['credentialListSid'], $this->solution['sid']);
        }
        return $this->context;
    }
    /**
