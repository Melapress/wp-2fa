 ...
 * /       /
 */
namespace WP2FA_Vendor\Twilio\Rest\Api\V2010\Account\Recording;
...
class TranscriptionInstance extends InstanceResource
{
    ...
    {
        if (!$this->context) {
            $this->context = new TranscriptionContext($this->version, $this->solution['accountSid'], $this->solution['recordingSid'], $this->solution['sid']);
        }
        return $this->context;
    }
    /**
