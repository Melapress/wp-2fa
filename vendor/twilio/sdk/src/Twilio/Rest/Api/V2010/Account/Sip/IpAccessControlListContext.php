...
use WP2FA_Vendor\Twilio\Rest\Api\V2010\Account\Sip\IpAccessControlList\IpAddressList;
...
class IpAccessControlListContext extends InstanceContext
{
    ...
    public function fetch() : IpAccessControlListInstance
    {
        ...
        return new IpAccessControlListInstance($this->version, $payload, $this->solution['accountSid'], $this->solution['sid']);
    }
    /**
    ...
    protected function getIpAddresses() : IpAddressList
    {
        if (!$this->_ipAddresses) {
            $this->_ipAddresses = new IpAddressList($this->version, $this->solution['accountSid'], $this->solution['sid']);
        }
