...
class InsightsQuestionnairesCategoryInstance extends InstanceResource
{
    ...
    public function __construct(Version $version, array $payload, string $categoryId = null)
    {
        ...
        $this->properties = ['accountSid' => Values::array_get($payload, 'account_sid'), 'categoryId' => Values::array_get($payload, 'category_id'), 'name' => Values::array_get($payload, 'name'), 'url' => Values::array_get($payload, 'url')];
    ...
    {
        if (!$this->context) {
            $this->context = new InsightsQuestionnairesCategoryContext($this->version, $this->solution['categoryId']);
        }
        return $this->context;
    }
    /**
