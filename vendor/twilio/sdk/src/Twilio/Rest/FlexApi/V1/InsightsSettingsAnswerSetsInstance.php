...
class InsightsSettingsAnswerSetsInstance extends InstanceResource
{
    ...
    public function __construct(Version $version, array $payload)
    {
        ...
        $this->properties = ['accountSid' => Values::array_get($payload, 'account_sid'), 'answerSets' => Values::array_get($payload, 'answer_sets'), 'answerSetCategories' => Values::array_get($payload, 'answer_set_categories'), 'notApplicable' => Values::array_get($payload, 'not_applicable'), 'url' => Values::array_get($payload, 'url')];
        $this->solution = [];
    }
    /**
