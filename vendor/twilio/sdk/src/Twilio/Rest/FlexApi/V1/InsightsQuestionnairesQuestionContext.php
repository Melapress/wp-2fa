...
class InsightsQuestionnairesQuestionContext extends InstanceContext
{
    ...
    public function update(string $question, string $description, string $answerSetId, bool $allowNa, array $options = []) : InsightsQuestionnairesQuestionInstance
    {
        ...
        $data = Values::of(['Question' => $question, 'Description' => $description, 'AnswerSetId' => $answerSetId, 'AllowNa' => Serialize::booleanToString($allowNa), 'CategoryId' => $options['categoryId']]);
        $headers = Values::of(['Token' => $options['token']]);
        $payload = $this->version->update('POST', $this->uri, [], $data, $headers);
        return new InsightsQuestionnairesQuestionInstance($this->version, $payload, $this->solution['questionId']);
    }
    /**
