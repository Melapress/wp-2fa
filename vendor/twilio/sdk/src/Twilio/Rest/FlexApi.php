...
use WP2FA_Vendor\Twilio\Rest\FlexApi\V1;
use WP2FA_Vendor\Twilio\Rest\FlexApi\V2;
/**
...
class FlexApi extends Domain
{
    ...
    protected function getChannel() : \WP2FA_Vendor\Twilio\Rest\FlexApi\V1\ChannelList
    {
     ...
     *                    fetch
     */
    protected function contextChannel(string $sid) : \WP2FA_Vendor\Twilio\Rest\FlexApi\V1\ChannelContext
    {
        return $this->v1->channel($sid);
    }
    protected function getConfiguration() : \WP2FA_Vendor\Twilio\Rest\FlexApi\V1\ConfigurationList
    {
        return $this->v1->configuration;
    }
    protected function contextConfiguration() : \WP2FA_Vendor\Twilio\Rest\FlexApi\V1\ConfigurationContext
    {
        return $this->v1->configuration();
    }
    protected function getFlexFlow() : \WP2FA_Vendor\Twilio\Rest\FlexApi\V1\FlexFlowList
    {
     ...
     */
    protected function contextFlexFlow(string $sid) : \WP2FA_Vendor\Twilio\Rest\FlexApi\V1\FlexFlowContext
    {
        return $this->v1->flexFlow($sid);
    }
    protected function getAssessments() : \WP2FA_Vendor\Twilio\Rest\FlexApi\V1\AssessmentsList
    {
        return $this->v1->assessments;
    }
    protected function contextAssessments() : \WP2FA_Vendor\Twilio\Rest\FlexApi\V1\AssessmentsContext
    {
        return $this->v1->assessments();
    }
    protected function getInsightsQuestionnairesCategory() : \WP2FA_Vendor\Twilio\Rest\FlexApi\V1\InsightsQuestionnairesCategoryList
    {
     ...
     */
    protected function contextInsightsQuestionnairesCategory(string $categoryId) : \WP2FA_Vendor\Twilio\Rest\FlexApi\V1\InsightsQuestionnairesCategoryContext
    {
        return $this->v1->insightsQuestionnairesCategory($categoryId);
    }
    protected function getInsightsQuestionnairesQuestion() : \WP2FA_Vendor\Twilio\Rest\FlexApi\V1\InsightsQuestionnairesQuestionList
    {
     ...
     */
    protected function contextInsightsQuestionnairesQuestion(string $questionId) : \WP2FA_Vendor\Twilio\Rest\FlexApi\V1\InsightsQuestionnairesQuestionContext
    {
        return $this->v1->insightsQuestionnairesQuestion($questionId);
    }
    protected function getInsightsSession() : \WP2FA_Vendor\Twilio\Rest\FlexApi\V1\InsightsSessionList
    {
        return $this->v1->insightsSession;
    }
    protected function contextInsightsSession() : \WP2FA_Vendor\Twilio\Rest\FlexApi\V1\InsightsSessionContext
    {
        return $this->v1->insightsSession();
    }
    protected function getInsightsSettingsAnswerSets() : \WP2FA_Vendor\Twilio\Rest\FlexApi\V1\InsightsSettingsAnswerSetsList
    {
        return $this->v1->insightsSettingsAnswerSets;
    }
    protected function getInsightsSettingsComment() : \WP2FA_Vendor\Twilio\Rest\FlexApi\V1\InsightsSettingsCommentList
    {
        return $this->v1->insightsSettingsComment;
    }
    protected function getInsightsUserRoles() : \WP2FA_Vendor\Twilio\Rest\FlexApi\V1\InsightsUserRolesList
    {
        return $this->v1->insightsUserRoles;
    }
    protected function contextInsightsUserRoles() : \WP2FA_Vendor\Twilio\Rest\FlexApi\V1\InsightsUserRolesContext
    {
        return $this->v1->insightsUserRoles();
    }
    protected function getInteraction() : \WP2FA_Vendor\Twilio\Rest\FlexApi\V1\InteractionList
    {
     ...
     * @param string $sid The SID that identifies the resource to fetch
     */
    protected function contextInteraction(string $sid) : \WP2FA_Vendor\Twilio\Rest\FlexApi\V1\InteractionContext
    {
        return $this->v1->interaction($sid);
    }
    protected function getWebChannel() : \WP2FA_Vendor\Twilio\Rest\FlexApi\V1\WebChannelList
    {
     ...
     */
    protected function contextWebChannel(string $sid) : \WP2FA_Vendor\Twilio\Rest\FlexApi\V1\WebChannelContext
    {
        return $this->v1->webChannel($sid);
    }
    protected function getWebChannels() : \WP2FA_Vendor\Twilio\Rest\FlexApi\V2\WebChannelsList
    {
