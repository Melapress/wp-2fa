...
use WP2FA_Vendor\Twilio\Rest\Autopilot\V1;
/**
...
class Autopilot extends Domain
{
    ...
    protected function getAssistants() : \WP2FA_Vendor\Twilio\Rest\Autopilot\V1\AssistantList
    {
     ...
     */
    protected function contextAssistants(string $sid) : \WP2FA_Vendor\Twilio\Rest\Autopilot\V1\AssistantContext
    {
        return $this->v1->assistants($sid);
    }
    protected function getRestoreAssistant() : \WP2FA_Vendor\Twilio\Rest\Autopilot\V1\RestoreAssistantList
    {
