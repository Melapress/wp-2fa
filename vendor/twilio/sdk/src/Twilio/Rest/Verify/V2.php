 ...
 * /       /
 */
namespace WP2FA_Vendor\Twilio\Rest\Verify;

use WP2FA_Vendor\Twilio\Domain;
use WP2FA_Vendor\Twilio\Exceptions\TwilioException;
use WP2FA_Vendor\Twilio\InstanceContext;
use WP2FA_Vendor\Twilio\Rest\Verify\V2\FormList;
use WP2FA_Vendor\Twilio\Rest\Verify\V2\SafelistList;
use WP2FA_Vendor\Twilio\Rest\Verify\V2\ServiceList;
use WP2FA_Vendor\Twilio\Rest\Verify\V2\TemplateList;
use WP2FA_Vendor\Twilio\Rest\Verify\V2\VerificationAttemptList;
use WP2FA_Vendor\Twilio\Rest\Verify\V2\VerificationAttemptsSummaryList;
