...
class ChallengeList extends ListResource
{
    ...
    public function create(string $factorSid, array $options = []) : ChallengeInstance
    {
        ...
        }), 'HiddenDetails' => Serialize::jsonObject($options['hiddenDetails']), 'AuthPayload' => $options['authPayload']]);
    ...
    {
        $options = new Values($options);
        $params = Values::of(['FactorSid' => $options['factorSid'], 'Status' => $options['status'], 'Order' => $options['order'], 'PageToken' => $pageToken, 'Page' => $pageNumber, 'PageSize' => $pageSize]);
