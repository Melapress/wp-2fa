...
use WP2FA_Vendor\Twilio\Rest\Verify\V2\Service\Entity\ChallengeList;
use WP2FA_Vendor\Twilio\Rest\Verify\V2\Service\Entity\FactorList;
use WP2FA_Vendor\Twilio\Rest\Verify\V2\Service\Entity\NewFactorList;
...
class EntityContext extends InstanceContext
{
    ...
    {
        if (!$this->_newFactors) {
            $this->_newFactors = new NewFactorList($this->version, $this->solution['serviceSid'], $this->solution['identity']);
        }
