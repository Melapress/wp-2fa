...
use WP2FA_Vendor\Twilio\Rest\Verify\V2\Service\Entity\Challenge\NotificationList;
...
class ChallengeContext extends InstanceContext
{
    ...
    public function update(array $options = []) : ChallengeInstance
    {
        ...
        $data = Values::of(['AuthPayload' => $options['authPayload'], 'Metadata' => Serialize::jsonObject($options['metadata'])]);
    ...
    protected function getNotifications() : NotificationList
    {
        if (!$this->_notifications) {
            $this->_notifications = new NotificationList($this->version, $this->solution['serviceSid'], $this->solution['identity'], $this->solution['sid']);
        }
