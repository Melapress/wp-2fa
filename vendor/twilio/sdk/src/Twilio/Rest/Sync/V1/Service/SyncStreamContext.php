...
use WP2FA_Vendor\Twilio\Rest\Sync\V1\Service\SyncStream\StreamMessageList;
...
class SyncStreamContext extends InstanceContext
{
    ...
    public function fetch() : SyncStreamInstance
    {
        ...
        return new SyncStreamInstance($this->version, $payload, $this->solution['serviceSid'], $this->solution['sid']);
    }
    /**
    ...
    protected function getStreamMessages() : StreamMessageList
    {
        if (!$this->_streamMessages) {
            $this->_streamMessages = new StreamMessageList($this->version, $this->solution['serviceSid'], $this->solution['sid']);
        }
