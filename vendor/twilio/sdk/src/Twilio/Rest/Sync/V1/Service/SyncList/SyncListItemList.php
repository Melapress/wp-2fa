 ...
 * /       /
 */
namespace WP2FA_Vendor\Twilio\Rest\Sync\V1\Service\SyncList;
...
class SyncListItemList extends ListResource
{
    ...
    public function create(array $data, array $options = []) : SyncListItemInstance
    {
        ...
        $data = Values::of(['Data' => Serialize::jsonObject($data), 'Ttl' => $options['ttl'], 'ItemTtl' => $options['itemTtl'], 'CollectionTtl' => $options['collectionTtl']]);
