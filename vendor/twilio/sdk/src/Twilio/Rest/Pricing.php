...
use WP2FA_Vendor\Twilio\Rest\Pricing\V1;
use WP2FA_Vendor\Twilio\Rest\Pricing\V2;
/**
...
class Pricing extends Domain
{
    ...
    protected function getMessaging() : \WP2FA_Vendor\Twilio\Rest\Pricing\V1\MessagingList
    {
        return $this->v1->messaging;
    }
    protected function getPhoneNumbers() : \WP2FA_Vendor\Twilio\Rest\Pricing\V1\PhoneNumberList
    {
        return $this->v1->phoneNumbers;
    }
    protected function getVoice() : \WP2FA_Vendor\Twilio\Rest\Pricing\V2\VoiceList
    {
        return $this->v2->voice;
    }
    protected function getCountries() : \WP2FA_Vendor\Twilio\Rest\Pricing\V2\CountryList
    {
     ...
     *                           fetch
     */
    protected function contextCountries(string $isoCountry) : \WP2FA_Vendor\Twilio\Rest\Pricing\V2\CountryContext
    {
        return $this->v2->countries($isoCountry);
    }
    protected function getNumbers() : \WP2FA_Vendor\Twilio\Rest\Pricing\V2\NumberList
    {
     ...
     *                                  pricing information
     */
    protected function contextNumbers(string $destinationNumber) : \WP2FA_Vendor\Twilio\Rest\Pricing\V2\NumberContext
    {
