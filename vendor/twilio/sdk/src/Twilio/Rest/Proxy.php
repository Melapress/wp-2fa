...
use WP2FA_Vendor\Twilio\Rest\Proxy\V1;
/**
...
class Proxy extends Domain
{
    ...
    protected function getServices() : \WP2FA_Vendor\Twilio\Rest\Proxy\V1\ServiceList
    {
     ...
     */
    protected function contextServices(string $sid) : \WP2FA_Vendor\Twilio\Rest\Proxy\V1\ServiceContext
    {
