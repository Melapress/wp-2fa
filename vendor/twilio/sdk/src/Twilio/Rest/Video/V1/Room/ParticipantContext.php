 ...
 * /       /
 */
namespace WP2FA_Vendor\Twilio\Rest\Video\V1\Room;

use WP2FA_Vendor\Twilio\Exceptions\TwilioException;
use WP2FA_Vendor\Twilio\InstanceContext;
use WP2FA_Vendor\Twilio\ListResource;
use WP2FA_Vendor\Twilio\Options;
use WP2FA_Vendor\Twilio\Rest\Video\V1\Room\Participant\AnonymizeList;
use WP2FA_Vendor\Twilio\Rest\Video\V1\Room\Participant\PublishedTrackList;
use WP2FA_Vendor\Twilio\Rest\Video\V1\Room\Participant\SubscribeRulesList;
use WP2FA_Vendor\Twilio\Rest\Video\V1\Room\Participant\SubscribedTrackList;
...
class ParticipantContext extends InstanceContext
{
    ...
    {
        if (!$this->_anonymize) {
            $this->_anonymize = new AnonymizeList($this->version, $this->solution['roomSid'], $this->solution['sid']);
        }
