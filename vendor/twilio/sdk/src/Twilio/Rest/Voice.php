...
use WP2FA_Vendor\Twilio\Rest\Voice\V1;
/**
...
class Voice extends Domain
{
    ...
    protected function getArchivedCalls() : \WP2FA_Vendor\Twilio\Rest\Voice\V1\ArchivedCallList
    {
     ...
     */
    protected function contextArchivedCalls(\DateTime $date, string $sid) : \WP2FA_Vendor\Twilio\Rest\Voice\V1\ArchivedCallContext
    {
        return $this->v1->archivedCalls($date, $sid);
    }
    protected function getByocTrunks() : \WP2FA_Vendor\Twilio\Rest\Voice\V1\ByocTrunkList
    {
     ...
     */
    protected function contextByocTrunks(string $sid) : \WP2FA_Vendor\Twilio\Rest\Voice\V1\ByocTrunkContext
    {
        return $this->v1->byocTrunks($sid);
    }
    protected function getConnectionPolicies() : \WP2FA_Vendor\Twilio\Rest\Voice\V1\ConnectionPolicyList
    {
     ...
     * @param string $sid The unique string that identifies the resource
     */
    protected function contextConnectionPolicies(string $sid) : \WP2FA_Vendor\Twilio\Rest\Voice\V1\ConnectionPolicyContext
    {
        return $this->v1->connectionPolicies($sid);
    }
    protected function getDialingPermissions() : \WP2FA_Vendor\Twilio\Rest\Voice\V1\DialingPermissionsList
    {
        return $this->v1->dialingPermissions;
    }
    protected function getIpRecords() : \WP2FA_Vendor\Twilio\Rest\Voice\V1\IpRecordList
    {
     ...
     * @param string $sid The unique string that identifies the resource
     */
    protected function contextIpRecords(string $sid) : \WP2FA_Vendor\Twilio\Rest\Voice\V1\IpRecordContext
    {
        return $this->v1->ipRecords($sid);
    }
    protected function getSourceIpMappings() : \WP2FA_Vendor\Twilio\Rest\Voice\V1\SourceIpMappingList
    {
     ...
     * @param string $sid The unique string that identifies the resource
     */
    protected function contextSourceIpMappings(string $sid) : \WP2FA_Vendor\Twilio\Rest\Voice\V1\SourceIpMappingContext
    {
