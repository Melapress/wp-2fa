...
use WP2FA_Vendor\Twilio\Rest\Insights\V1;
/**
...
class Insights extends Domain
{
    ...
    protected function getSettings() : \WP2FA_Vendor\Twilio\Rest\Insights\V1\SettingList
    {
        return $this->v1->settings;
    }
    protected function contextSettings() : \WP2FA_Vendor\Twilio\Rest\Insights\V1\SettingContext
    {
        return $this->v1->settings();
    }
    protected function getCalls() : \WP2FA_Vendor\Twilio\Rest\Insights\V1\CallList
    {
     ...
     */
    protected function contextCalls(string $sid) : \WP2FA_Vendor\Twilio\Rest\Insights\V1\CallContext
    {
        return $this->v1->calls($sid);
    }
    protected function getCallSummaries() : \WP2FA_Vendor\Twilio\Rest\Insights\V1\CallSummariesList
    {
        return $this->v1->callSummaries;
    }
    protected function getConferences() : \WP2FA_Vendor\Twilio\Rest\Insights\V1\ConferenceList
    {
     ...
     */
    protected function contextConferences(string $conferenceSid) : \WP2FA_Vendor\Twilio\Rest\Insights\V1\ConferenceContext
    {
        return $this->v1->conferences($conferenceSid);
    }
    protected function getRooms() : \WP2FA_Vendor\Twilio\Rest\Insights\V1\RoomList
    {
     ...
     */
    protected function contextRooms(string $roomSid) : \WP2FA_Vendor\Twilio\Rest\Insights\V1\RoomContext
    {
