 ...
 * /       /
 */
namespace WP2FA_Vendor\Twilio\Rest\Preview\Sync;
...
class ServiceList extends ListResource
{
    ...
    public function create(array $options = []) : ServiceInstance
    {
        ...
        $data = Values::of(['FriendlyName' => $options['friendlyName'], 'WebhookUrl' => $options['webhookUrl'], 'ReachabilityWebhooksEnabled' => Serialize::booleanToString($options['reachabilityWebhooksEnabled']), 'AclEnabled' => Serialize::booleanToString($options['aclEnabled'])]);
