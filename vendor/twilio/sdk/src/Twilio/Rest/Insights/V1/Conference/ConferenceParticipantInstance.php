...
class ConferenceParticipantInstance extends InstanceResource
{
    ...
    {
        if (!$this->context) {
            $this->context = new ConferenceParticipantContext($this->version, $this->solution['conferenceSid'], $this->solution['participantSid']);
        }
        return $this->context;
    }
    /**
